      ...
      <Router>
        <Layout>
          <Routes>
            ...
            {/* Debug Route */}
            <Route
              path="/debug/log-me-in/:accountName"
              element={<DebugLogin />}
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  requiredAccountType="Employee"
                  requiredRoles={["EMPLOYEE_TICKETING", "EMPLOYEE_ADMIN"]}
                >
                  <TicketingManagement />
                </ProtectedRoute>
              }
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  requiredAccountType="Employee"
                  requiredRoles={["EMPLOYEE_SUPPORT", "EMPLOYEE_ADMINISTRATOR"]}
                >
                  <CustomerSupport />
                </ProtectedRoute>
              }
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  requiredAccountType="Employee"
                  requiredRoles={["EMPLOYEE_ACCOUNTING", "EMPLOYEE_ADMIN"]}
                >
                  <Statistics />
                </ProtectedRoute>
              }
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  requiredAccountType="Employee"
                  requiredRoles={["EMPLOYEE_ADMINISTRATOR"]}
                >
                  <AdminPanel />
                </ProtectedRoute>
              }
