...
const RegisterForm: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterRequestWithConfirm) => {
    try {
      ...
      const { confirmPassword: _confirmPassword, ...submitData } = data; // Remove confirmPassword from data
        ...
        <Col xs={12} md={8} lg={6}>
          <Card>
            <Card.Header className="text-center bg-primary text-white">
              ...
              <p className="mb-0">
                Tham gia với chúng tôi để bắt đầu đặt vé máy bay
              </p>
            </Card.Header>
                    ...
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control
                        ...
                        {...register("accountName", {
                          ...
                          pattern: {
                            value: /^[\p{L}\s'.-]+$/u,
                            message: "Họ và tên chỉ có thể chứa kí tự",
                          },
                        })}
                    ...
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control
                        ...
                        {...register("citizenId", {
                          ...
                          minLength: {
                            value: 9,
                            message: "CCCD phải có ít nhất 9 ký tự",
                          },
                        })}
