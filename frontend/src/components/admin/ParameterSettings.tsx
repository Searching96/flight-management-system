...
export const ParameterSettings: React.FC<ParameterSettingsProps> = ({
  ...
  const loadParameters = React.useCallback(async () => {
    setLoading(true);
    setError(null);
    try {
    ...
    <Container className="py-4" style={{ maxWidth: "800px" }}>
      ...
      <Card>
        <Card.Body className="p-4">
          <Form
            onSubmit={
              readOnly ? (e) => e.preventDefault() : handleSubmit(onSubmit)
            }
          >
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      {...register("maxMediumAirport", {
                        required:
                          !readOnly &&
                          "Số sân bay trung gian tối đa là bắt buộc",
                        min: { value: 0, message: "Giá trị phải ít nhất là 0" },
                        max: {
                          value: 10,
                          message: "Giá trị phải nhiều nhất là 10",
                        },
                        valueAsNumber: true,
                      })}
                    ...
                    <Form.Text className="text-muted">
                      Quy định số điểm dừng trung gian tối đa được phép cho mỗi
                      chuyến bay
                    </Form.Text>
                  </Form.Group>
                </Col>
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      {...register("minFlightDuration", {
                        required:
                          !readOnly && "Thời gian bay tối thiểu là bắt buộc",
                        min: {
                          value: 30,
                          message: "Thời gian tối thiểu là 30 phút",
                        },
                        max: {
                          value: 1440,
                          message: "Thời gian tối đa là 24 giờ (1440 phút)",
                        },
                        valueAsNumber: true,
                      })}
            ...
            <div className="mb-5 pb-4 border-bottom">
              ...
              <Row className="g-4">
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="fw-bold">
                      Thời gian dừng chân tối thiểu (phút)
                    </Form.Label>
                    <Form.Control
                      type="number"
                      min="30"
                      ...
                      {...register("minLayoverDuration", {
                        required:
                          !readOnly &&
                          "Thời gian dừng chân tối thiểu là bắt buộc",
                        min: {
                          value: 30,
                          message: "Thời gian dừng chân tối thiểu là 30 phút",
                        },
                        max: {
                          value: 720,
                          message:
                            "Thời gian dừng chân tối đa là 12 giờ (720 phút)",
                        },
                        valueAsNumber: true,
                      })}
                    ...
                    <Form.Text className="text-muted">
                      Quy định thời gian dừng chân tối thiểu cần thiết giữa các
                      chuyến bay kết nối
                    </Form.Text>
                  </Form.Group>
                </Col>
                ...
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="fw-bold">
                      Thời gian dừng chân tối đa (phút)
                    </Form.Label>
                    <Form.Control
                      type="number"
                      min="60"
                      ...
                      {...register("maxLayoverDuration", {
                        required:
                          !readOnly && "Thời gian dừng chân tối đa là bắt buộc",
                        min: {
                          value: 60,
                          message: "Thời gian tối thiểu là 60 phút",
                        },
                        max: {
                          value: 1440,
                          message: "Thời gian tối đa là 24 giờ (1440 phút)",
            ...
            <div className="mb-4">
              ...
              <Row className="g-4">
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="fw-bold">
                      Thời gian đặt vé trước tối thiểu (ngày)
                    </Form.Label>
                    <Form.Control
                      type="number"
                      min="0"
                      ...
                      {...register("minBookingInAdvanceDuration", {
                        required:
                          !readOnly &&
                          "Thời gian đặt vé trước tối thiểu là bắt buộc",
                        min: { value: 0, message: "Thời gian không được âm" },
                        valueAsNumber: true,
                      })}
                      isInvalid={
                        !readOnly && !!errors.minBookingInAdvanceDuration
                      }
                    />
                    {!readOnly && (
                      <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Text className="text-muted">
                      Quy định số ngày tối thiểu khách hàng phải đặt vé trước
                      khi khởi hành
                    </Form.Text>
                  </Form.Group>
                </Col>
                ...
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      {...register("maxBookingHoldDuration", {
                        ...
                        max: {
                          value: 720,
                          message:
                            "Thời gian giữ chỗ tối đa là 720 giờ (30 ngày)",
                        },
                        valueAsNumber: true,
                      })}
                    ...
                    <Form.Text className="text-muted">
                      Quy định thời gian tối đa hệ thống giữ chỗ trước khi yêu
                      cầu thanh toán
                    </Form.Text>
                  </Form.Group>
                </Col>
              ...
              <ul className="small text-muted mb-0">
                {readOnly ? (
                  ...
                  <>
                    ...
                    <li>
                      Thay đổi quy định có thể ảnh hưởng đến đặt vé hiện tại
                    </li>
                    <li>Thời gian tính bằng phút (1 giờ = 60 phút)</li>
                  </>
                )}
            ...
            <Col md={6}>
              <ul className="small text-muted mb-0">
                {readOnly ? (
                  ...
                  <>
                    <li>
                      Chỉ quản trị viên và nhân viên dịch vụ mới có quyền thay
                      đổi
                    </li>
